...
\begin{figure}
    \centering
        \includegraphics[width=0.45\textwidth]{fig1_submit.png}
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.49\textwidth]{fig2_submit}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.50\textwidth]{sup3dEC}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.65\textwidth]{si_error1_original}
