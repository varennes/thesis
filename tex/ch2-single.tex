...
Cell chemotaxis simulations are implemented using the Cellular Potts Model (CPM) \cite{graner1992simulation,swat2012multi}. The CPM used here is similar to that used in our previous study \cite{varennes2016collective}. The source code for the simulations can be found here \cite{ch2code}.
...
With Eq.\ \ref{eq:p1} and the restrictions on $T(\theta,\theta')$ (Eq.\ \ref{eq:t2}-\ref{eq:t5}), Othmer \textit{et al}.\ derive the moments for the BPRW.
